...
public class ViewPagerFirstLastMetroAdapter extends FragmentStatePagerAdapter {
    ArrayList<ArrayList<String>> allAvailableRoutes;

    public ViewPagerFirstLastMetroAdapter(@NonNull FragmentManager fm, ArrayList<ArrayList<String>> allAvailableRoutes) {
        super(fm);
    ...
    public CharSequence getPageTitle(int position) {
        if (position == 0) return "FIRST METRO";
        else return "LAST METRO";
