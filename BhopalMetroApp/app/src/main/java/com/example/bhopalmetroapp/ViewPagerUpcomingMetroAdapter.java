...
public class ViewPagerUpcomingMetroAdapter extends FragmentStatePagerAdapter {
    ArrayList<ArrayList<String>> allAvailableRoutes;

    public ViewPagerUpcomingMetroAdapter(@NonNull FragmentManager fm, ArrayList<ArrayList<String>> allAvailableRoutes) {
        super(fm);
